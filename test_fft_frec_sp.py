...
for i in range(inicio_punto_espacial, fin_punto_espacial):
    ...
    output_filename = f"SF_{first_datetime_clean[:8]}_{first_datetime_clean[8:]}_{last_datetime_clean[8:]}_SP{iteration_number}.mat"

    # Construye el nombre del diccionario con el número de iteración
        
    features_name = f"SF_{first_datetime_clean[:8]}_{first_datetime_clean[8:]}_{last_datetime_clean[8:]}_SP{iteration_number}"
